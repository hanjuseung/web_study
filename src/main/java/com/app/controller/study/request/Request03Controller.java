...
public class Request03Controller {
	...
	//public String param8Action(@ModelAttribute Product product) {	// xxxxAction xxxx
	public String param8Action(@ModelAttribute ProductRequestForm productRequestForm) {	// xxxxAction xxxx
